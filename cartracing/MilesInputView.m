...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [subBtn.titleLabel setFont:[UIFont fontWithName:@"Arial-BoldItalicMT" size:24]];
...
-(void)setNumber:(NSInteger)num
{
 //   NSLog(@"set number %d",num);
    number.text=[NSString stringWithFormat:@"%d",(int)num];
}
...
-(void) incNumber
{
    ...
    num=(num+1)%10;
    [number setText:[NSString stringWithFormat:@"%d",(int)num]];
}
